...
<link href="css/style.css" rel="stylesheet" type="text/css" />
  ...
  <div id="interior">
    ...
    <div id="mid">
      ...
      <div id="maintext">
        <div id="apDiv1">
            <form name="form" action="addpinfo.jsp" onsubmit="return info()">
                <table width="400" height="400" border="0" align="center">
                    <tr>
                        <td  class="STYLE7">用户帐号：</td>
                        <td>
                            <input name="userId" type="text" class="STYLE7" id="userId"  />                        </td>
                    </tr>
                    <tr>
                        <td class="STYLE7">用户姓名：</td>
                        <td>
                            <input name="userName" type="text" class="STYLE7" id="userName"  />                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="passWord" type="text" class="STYLE7" id="passWord"  />                        </td>
                    </tr>
                    <tr>
                        <td class="STYLE7">电话号码：</td>
                        <td>
                            <input name="telNumber" type="text" class="STYLE7" id="telNumber"  />                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>
